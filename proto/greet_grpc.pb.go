...
type GreetService_SayHelloClientStreamingClient interface {
	...
	CloseAndRecv() (*MessageLists, error)
	grpc.ClientStream
}
...
func (x *greetServiceSayHelloClientStreamingClient) CloseAndRecv() (*MessageLists, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(MessageLists)
...
func (x *greetServiceSayHelloBidirectionalStreamingClient) Send(m *HelloRequests) error {
	return x.ClientStream.SendMsg(m)
}
...
type GreetService_SayHelloClientStreamingServer interface {
	SendAndClose(*MessageLists) error
	Recv() (*HelloResponse, error)
	grpc.ServerStream
}
...
func (x *greetServiceSayHelloClientStreamingServer) SendAndClose(m *MessageLists) error {
	return x.ServerStream.SendMsg(m)
}
...
func (x *greetServiceSayHelloBidirectionalStreamingServer) Recv() (*HelloRequests, error) {
	m := new(HelloRequests)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
